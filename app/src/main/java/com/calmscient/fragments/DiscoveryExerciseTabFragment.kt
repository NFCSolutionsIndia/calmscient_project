...
class DiscoveryExerciseTabFragment : Fragment() {
    ...
    private val discoveryExerciseItems = mutableListOf<DailyJournal>()
    ...
    fun newInstance(date: LocalDate): DiscoveryExerciseTabFragment {
        val fragment = DiscoveryExerciseTabFragment()
        val bundle = Bundle()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            selectedDate = it.getSerializable(DiscoveryExerciseTabFragment.ARG_SELECTED_DATE) as? LocalDate
        }
    }
