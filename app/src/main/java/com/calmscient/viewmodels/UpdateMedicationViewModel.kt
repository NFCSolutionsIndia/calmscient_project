...
@HiltViewModel
class UpdateMedicationViewModel @Inject constructor(private val repository: MedicationsRepository) : ViewModel() {

    val saveResponseLiveData: MutableLiveData<AlarmUpdateResponse?> = MutableLiveData()
    ...
    val failureResponseData: MutableLiveData<AlarmUpdateResponse?> = MutableLiveData()
    ...
    private suspend fun handleResponse(call: Call<AlarmUpdateResponse>) {
