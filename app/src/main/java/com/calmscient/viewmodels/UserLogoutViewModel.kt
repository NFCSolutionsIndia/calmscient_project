...
@HiltViewModel
class UserLogoutViewModel @Inject constructor(private val repository: UserProfileRepository) : ViewModel() {
    ...
    fun userLogout(accessToken:String) {
        ...
        viewModelScope.launch {
            try {
                val response = repository.logoutUser(accessToken)
